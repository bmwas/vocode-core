...
class RecordEmail(
    ...
    description: str = """
Extract and record caller's full name and email address from transcript.
MUST use this if any of caller's information changes or updated during call.
Requirements:
...
Performs extra validation to ensure the accuracy.
"""
