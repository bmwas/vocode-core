...
Ends the current conversation; use this to determine when to should hang up. Use this
...
hang up. Example farewell phrases: goodbye, ok bye, so long, see you, later, take care, etc. People will
